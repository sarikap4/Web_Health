...
Public Class Add_CityDetails
	...
	Private Sub btnSaveandExit_Click(sender As Object, e As EventArgs) Handles btnSaveandExit.Click
		Try
			Connection()
			Response.Redirect("ListallCity.aspx")
	...
	Function Connection()
		...
		Dim cmd As New SqlCommand("AddCity", con)

		cmd.CommandType = CommandType.StoredProcedure
		'cmd.Parameters.Add("@ID", SqlDbType.Int,).Value = 2
		cmd.Parameters.Add("@CityName", SqlDbType.VarChar, 100).Value = txtCityName.Text.Trim
