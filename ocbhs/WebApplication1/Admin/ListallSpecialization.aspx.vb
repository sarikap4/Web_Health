...
Public Class ListallSpecialization
	...
	Public Sub BindData()
		...
		Dim cmd As New SqlCommand("ListSpecialization", con)
	...
	Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
		Response.Redirect("Add_SpecializationDetails.aspx")
	End Sub
	...
	Private Sub btndelete_Click(sender As Object, e As EventArgs) Handles btndelete.Click
		For i As Integer = 0 To gvDieases.Rows.Count - 1
			...
			If chkcity.Checked = True Then
				...
				Dim cmd As New SqlCommand("DeleteSpecialization", con)

				cmd.CommandType = CommandType.StoredProcedure
				'cmd.Parameters.Add("@ID", SqlDbType.Int,).Value = 2
				cmd.Parameters.Add("@Scode", SqlDbType.VarChar, 50).Value = gvDieases.Rows(i).Cells(3).Text
