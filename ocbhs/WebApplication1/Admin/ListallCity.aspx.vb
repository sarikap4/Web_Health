...
Public Class ListallCity
	...
	Public Sub BindData()
		...
		Dim cmd As New SqlCommand("ListallCity", con)
	...
	Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
		Response.Redirect("Add_CityDetails.aspx")
	End Sub
	...
	Private Sub btndelete_Click(sender As Object, e As EventArgs) Handles btndelete.Click
		For i As Integer = 0 To gvDieases.Rows.Count - 1
			...
			If chkcity.Checked = True Then
				...
				Dim cmd As New SqlCommand("DeleteCity", con)

				cmd.CommandType = CommandType.StoredProcedure
				'cmd.Parameters.Add("@ID", SqlDbType.Int,).Value = 2
				cmd.Parameters.Add("@CCode", SqlDbType.VarChar, 50).Value = gvDieases.Rows(i).Cells(3).Text
